        ...
        >
          ...
          <div
            style={{
              ...
              height: "1px",
              background:
                "linear-gradient(to right, transparent, var(--text-primary) 40%, transparent)",
      ...
      <main
        style={{
          ...
          animation: showContent
            ? `contentReveal 0.6s cubic-bezier(0.4,0,0.2,1) forwards`
            : "none",
        }}
      >
        {/* Hero */}
        <div style={{ marginBottom: "6rem" }}>
          ...
          >
            Enter a company domain. Reachr finds similar companies, locates
            their decision makers, and sends personalised emails, all in under a
            minute.
          </p>
            ...
            >
              {betaStatus === "done" ? (
                ...
                >
                  ...
                  >
                    Reachr is currently invite-only while sending is in testing.
                  ...
                  <button
                    ...
                    style={{
                      ...
                      fontWeight: 600,
                      cursor:
                        betaStatus === "submitting" ? "not-allowed" : "pointer",
